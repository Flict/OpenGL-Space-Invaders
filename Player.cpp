...
const GLfloat vertices[] = {
	...
	// Turret - Front Face
	-0.1f, 1.2f, 0.5f, 1.0f,	1.0f, 1.0f, 1.0f, 1.0f,		1.0f, 0.0f, // Front Top Left 0
	-0.1f, 0.5f, 0.5f, 1.0f,	1.0f, 1.0f, 1.0f, 1.0f,		1.0f, 1.0f, // Front Bottom Left 1
	0.1f, 1.2f, 0.5f, 1.0f,		1.0f, 1.0f, 1.0f, 1.0f,		0.0f, 0.0f, // Front Top Right 2
	0.1f, 0.5f, 0.5f, 1.0f,		1.0f, 1.0f, 1.0f, 1.0f,		0.0f, 1.0f, // Front Bottom Right 3
...
Player::Player() : GameObject(Mesh(vertices, sizeof(vertices), indices, sizeof(indices)), glm::vec2(1.f, 1.7), GameObjectType::player, glm::vec3(0.f , 0.f , 0.f), "./assets/blue-pattern.bmp")
{
